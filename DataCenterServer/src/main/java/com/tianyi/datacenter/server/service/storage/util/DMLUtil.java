...
public class DMLUtil {
    ...
    public static String generateDML(DataStorageDMLVo dmlVo, PageListVo pageInfo) throws DataCenterException {
        ...
        switch (dmlVo.getDmlType()) {
            ...
            case "C":
                ...
                break;
            case "U":
                dmlSql = generateUpdateSql(dmlVo.getDataObject(), dmlVo.getUpdateInfo(), dmlVo.getCondition());
                if (dmlSql == null) {
                    throw new DataCenterException("", "");
                }
                break;
     ...
     * 2018/11/24 17:39
     */
    private static String generateUpdateSql(DataObject dataObject, Map<String, Object> updateInfo, Map<String, Object> condition){
        String dmlSql;
        //组装ftl的root节点
