        ...
        <div class="viewTableClass">
            ...
            <#if model_column?exists>
                <#list model_column as model>
                    <el-table-column prop="${model.columnName}" label="${model.columnComment}"
            ...
            <#if model_column?exists>
                ...
                <#list model_column as model>
                    ...
                    <#elseif model.columnType ='DATETIME'||model.columnType = 'TIMESTAMP'|| model.columnType = 'datatime'|| model.columnType = 'timestamp'|| model.columnType = 'DATE'|| model.columnType = 'date'>
                        <el-form-item label="${model.columnComment}" prop="${model.columnName}">
                            <el-date-picker
                                    v-model="viewAdd.data.${model.columnName}"
                                    align="right"
                                    type="date"
                                    placeholder="选择日期"
                            >
...
<script>
    ...
    ,
        ...
        editSingle()
        {
            axios.post('/${table_name?uncap_first}/update', this.viewEdit.data)
                    .then(res = > {
                if(res.data.success
        )
            {
    ...
    ,
        ...
        deletSingle()
        {
            axios.post('/${table_name?uncap_first}/delete', this.viewDelet.data)
                    .then(res = > {
                if(res.data.success){
    ...
    addSingle()
    {
        ...
        axios.post('/${table_name?uncap_first}/add', params)
                .then(res = > {
            if(res.data.success
    )
        {
    ...
    getTableData(params)
    {
        axios.post('/${table_name?uncap_first}/list', params)
                .then(res = > {
            if(res.data.success
    )
        {
